...
namespace LaboratorioClinico.util
{
    public class Ticket
    {
        ...
        private void DrawImage()
        {
            if (headerImage != null)
            {
                try
                {
                    ...
                    double height = ((double)headerImage.Height / 58) * 5;  // Aqui va 15 para los logos cuadrados
        ...
        private void DrawItems()
        {
            ...
            gfx.DrawString("NUM   PRODUCTO           IMPORTE", printFont, myBrush, leftMargin, YPosition(), new StringFormat());
